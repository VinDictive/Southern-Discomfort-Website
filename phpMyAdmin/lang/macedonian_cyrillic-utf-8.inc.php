...
$strSetupExport_asfile_name = 'Сочувај како податотека';
$strSetupExport_compression_name = 'Компресија';
$strSetupExport_format_name = 'Формат';
$strSetupExport_onserver_overwrite_name = 'Препиши ги постоечките податотеки';
$strSetupForm_Left_databases = 'База на податоци';
$strSetupForm_Left_tables = 'Табели';
$strSetupForm_Query_window = 'Прозорец за упити';
