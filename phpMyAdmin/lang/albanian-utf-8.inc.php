...
$strAccessDenied = 'Ndalohet hyrja';
$strAction = 'Veprimi';
$strAddAutoIncrement = 'Shto vlerë AUTO_INCREMENT';
$strAddClause = 'Shto %s';
$strAddConstraints = 'Shto kushte';
$strAddDeleteColumn = 'Shto/Fshi kollonat e fushës';
$strAddDeleteRow = 'Shto/Fshi rreshtin e kriterit';
...
$strAfter = 'Mbas %s';
$strAllTableSameWidth = 'Shfaq të gjitha tabelat me të njëjtën gjerësi';
$strAll = 'Të gjithë';
...
$strBLOBRepositoryDamaged = 'Me dëme';
$strBLOBRepositoryDisable = 'Çaktivizo';
$strBLOBRepositoryEnable = 'Aktivizo';
...
$strCopyDatabaseOK = 'Databaza %s është kopjuar tek %s';
...
$strCreateDatabaseBeforeCopying = 'CREATE DATABASE para se të kopjohet';
...
$strDatabaseEmpty = 'Mungon emri i databazës!';
$strDatabaseExportOptions = 'Opcione të eksportimit të databazës';
$strDatabaseHasBeenCreated = 'U krijua baza e të dhënave %1$s.';
...
$strDataOnly = 'Vetëm të dhënat';
$strData = 'Të dhëna';
$strDBComment = 'Komenti për databazën: ';
$strDBCopy = 'Kopjo databazën në';
...
$strDisplayPDF = 'Shfaq skemën PDF';
...
$strEdit = 'Ndrysho';
$strEditPDFPages = 'Ndrysho faqet PDF';
...
$strHaveToShow = 'Zgjidh të paktën një kollonë për të shfaqur';
$strHebrew = 'Hebraike';
...
$strPaperSize = 'Përmasat e fletës';
...
$strQueryOnDb = 'Kërkesë SQL tek databaza <b>%s</b>:';
...
$strRelationNotWorking = 'Karakteristikat shtesë janë çaktivizuar për sa i takon funksionimit me tabelat e lidhura. Për të kuptuar përse, klikoni %skëtu%s.';
...
$strSetupExport_asfile_name = 'Ruaje me emër...';
$strSetupExport_compression_name = 'Kompresim';
$strSetupExport_format_name = 'Formati';
$strSetupExport_onserver_overwrite_name = 'Mbishkruaj file(s) ekzistues';
$strSetupForm_Left_databases = 'Databazat';
$strSetupForm_Left_tables = 'Tabela';
$strSetupForm_Query_window = 'Dritarja e Query';
$strSetupSQLQuery_Edit_name = 'Ndrysho';
$strSetupSQLQuery_Explain_name = 'Shpjego SQL';
$strSetupSQLQuery_Refresh_name = 'Rifresko';
$strSetupSQLQuery_ShowAsPHP_name = 'Krijo kodin PHP';
...
$strShowKeys = 'Shfaq vetëm kyçet';
$strShowPHPInfo = 'Trego info mbi PHP';
$strShow = 'Shfaq';
$strShowStatusReset = 'Rinis';
$strShowTableDimension = 'Shfaq madhësinë e tabelave';
...
$strSplitWordsWithSpace = 'Fjalët veçohen me anë të një hapësirë bosh (" ").';
...
$strTotal = 'Gjithsej';
$strTotalUC = 'Gjithsej';
$strTrackingIsActive = 'Gjurmimi është aktiv.';
...
$strViewHasBeenDropped = 'Paraqitja %s u eleminua';
$strView = 'Paraqitje';
...
$strWindowNotFound = 'Dritarja e destinuar e shfletuesit nuk mund të rifreskohet. Ka mundësi të keni mbyllur dritaren prind ose rregullimet mbrojtëse të shfletuesit tuaj të ndalojnë përditësimet nëpërmjet dritareve.';
